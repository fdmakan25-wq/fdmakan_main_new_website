...
import {
  OPEN_SIDES_OPTIONS,
  parseCommercialLandSaleFields,
  type CommercialLandSaleFields,
  type YesNo,
} from '@/lib/commercial-land-sale-fields';
...
interface SaleCommercialLandFormProps {
...
export default function SaleCommercialLandForm({
  fields: rawFields,
  onChange,
  underlineInputClass,
  hideSaleSections = false,
}: SaleCommercialLandFormProps) {
  const fields = parseCommercialLandSaleFields(rawFields);

  const update = (patch: Partial<CommercialLandSaleFields>) => {
      ...
      <div>
        ...
        <div>
          ...
          >
            ...
            {COMMERCIAL_LAND_ZONE_OPTIONS.map((zone) => (
          ...
          <div className="flex flex-wrap gap-6">
            {[
              ...
              <label key={opt.value} className="inline-flex items-center gap-2 cursor-pointer">
                <input
                  type="radio"
                  name="commercialLandTransactionType"
